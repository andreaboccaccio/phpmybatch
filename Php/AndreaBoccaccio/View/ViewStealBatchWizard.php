 ...
 * 
 */
class Php_AndreaBoccaccio_View_ViewStealBatchWizard extends Php_AndreaBoccaccio_View_ViewParamsWizardAbstract {
	...
	private function __construct() {
		...
		$this->setKind('batchStealWizard');
		$this->setWizard(Php_AndreaBoccaccio_Model_StealBatchWizard::getInstance());
		$this->setQueryId('stealBatch');
	
	}
	
	public static function getInstance() {
		if(self::$instance == null) {
			self::$instance = new Php_AndreaBoccaccio_View_ViewStealBatchWizard();
		}
